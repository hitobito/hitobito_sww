...
* Auf dem Personenprofil ist nun eine Funktion "Aufteilen" verfügbar, um Familienprofile in Einzelpersonen mit gemeinsamem Haushalt aufzuteilen (hitobito_sww#268)
* Anwender können ihren eigenen Namen und ihre Haupt-E-Mail-Adress nicht mehr selbständig ändern, um die Datenqualität zu verbessern (hitobito_sww#307)
...
- Drucken eines Mitgliederausweises mittels Rechnungslauf (hitobito_sww#63)
